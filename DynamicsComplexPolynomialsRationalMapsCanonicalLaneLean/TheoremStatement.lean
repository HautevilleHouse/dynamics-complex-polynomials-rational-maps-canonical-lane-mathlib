import DynamicsComplexPolynomialsRationalMapsCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement :=
  { sourceKey := sourceRepository,
    ...
    manifoldConstrainedStatement := "manifold-constrained theorem certificate internalized through baseline dynamics gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
